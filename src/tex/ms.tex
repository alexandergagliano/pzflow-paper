...
\affiliation{Department of Astronomy and Center for AstroPhysical Surveys, University of Illinois at Urbana-Champaign, Urbana, IL 61801, USA}
...
The code to reproduce the figures in this paper is hosted publicly on Github\footnote{\url{https://github.com/jfcrenshaw/pzflow-paper}}, and the code for each individual figure can be found by clicking on the Github logo in the margin next to that figure.
